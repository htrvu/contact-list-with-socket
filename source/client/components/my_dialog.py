...
class MyDialog(QDialog):
    def __init__(self, title=None, msg=None, parent=None):
        ...
        # Stylesheet
        self.setStyleSheet("QDialog {background-color: qlineargradient( x1:0 y1:0, x2:1 y2:0, stop:0 #acb6e5,  stop:1 #86fde8); } QLabel {color: #2d1299; font-size: 20px; font-weight: bold;}")
